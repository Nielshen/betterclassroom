...
<template>
  <div class="flex justify-center item-center">
    <div class="flex flex-col w-2/3">
      ...
      <input v-model="taskName" class="input input-bordered input-accent w-full max-w-xs my-5"
             placeholder="Aufgabenname"
             type="text"/>
      <textarea v-model="taskDescription" class="textarea textarea-accent my-5 overflow-auto"
                placeholder="Beschreibung der Aufgabe" style="min-height: 100px;"></textarea>
      <div class="overflow-x-auto w-full">
        <h2 class="text-xl my-5">Unteraufgaben</h2>
        <input v-model="subtaskName" class="input input-md input-bordered input-accent w-full"
               placeholder="Unteraufgabentitel"
               type="text"/>
        <div class="flex items-center">
          <textarea v-model="subtask"
                    class="textarea textarea-accent my-5 overflow-auto flex-grow"
                    placeholder="Beschreibung der Unteraufgabe" style="min-height: 200px;"></textarea>
        </div>
        <button v-if="!isEditing" class="btn btn-accent mb-5 float-right" @click="createSubTask">&#65291 Unteraufgabe
          hinzufügen
        </button>
