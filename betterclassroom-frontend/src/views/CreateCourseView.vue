...
<template>
  <div class="flex justify-center item-center">
    <div class="flex flex-col w-2/3">
      ...
      <input v-model="courseName" class="input input-bordered input-accent w-full max-w-xs my-5" placeholder="Kursname"
             type="text"/>
      <input v-model="courseRoom" class="input input-bordered input-accent w-full max-w-xs my-5" placeholder="Raum"
             type="text"/>
